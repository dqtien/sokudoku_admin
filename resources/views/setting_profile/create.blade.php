        ...
        <div id="editUser">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>プロフィールを更新
                    </div>
                    <div class="tools">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group" style="text-align: left">
                                    <img src="{{$avatar}}" id="img_avatar" name="avatar"
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{$email}}" type="text" name="email" class="form-control"
                                           id="editUserEmail"
                                           placeholder="Email">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>電話</label>
                                    {!! Form::text('phone', $phone, array('maxlength'=>'15','class' => 'form-control', 'id' => 'phone')) !!}
                                </div>
                            </div>
...
@section("after-scripts-end")
    ...
    <script src="{{ asset('js/page/profile/index.js') }}"></script>
@endsection