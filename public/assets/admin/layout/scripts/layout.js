...
$(document).ready(function () {
    $(".close").click(function () {
        $(this).parent().append('<input type="hidden" name="deletes[]" value="' + $(this).data('delete') + '"/>');
        $(this).parent().hide();
    });
    $(".search-body").hide();
    ...
    $('#deleteModal').on('hidden.bs.modal', function () {
        //clear form
        $('#updateThemeError').empty('');
    });

    // delete element
    $('.deleteElement').on('click', function () {
        // Get the record's ID via attribute
        var deleteForm = $("#form-temp").html();
        deleteForm = deleteForm.replace("delete_id", $(this).data('id'));
        deleteForm = deleteForm.replace("delete_element", 'destroy');
        $("#form-delete").html(deleteForm);
